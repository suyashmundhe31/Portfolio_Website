...
import achievement1Image from '../assets/img/achievement1_post_img.jpg';
...
import achievement2Image from '../assets/img/achievement2_post_img.png';
      ...
      <section className="bg-white border-t-2 border-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="flex items-center justify-between mb-8 sm:mb-12">
            ...
            <Link to="/blog" className="font-mono text-sm underline hover:no-underline">
